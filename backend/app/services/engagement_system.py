...
def start_engagement_detection():
    print("Engagement detection system started...")
    while True:
            ...
            if results.multi_face_landmarks:
                ...
                if inattention_start_time:
                    ...
                    if inattention_duration > attention_threshold:
                        ...
                        # Convert the final results to human-readable format
                        ...
                        # Prepare the final engagement data
                ...
                if no_face_duration > attention_threshold:
                    ...
                    with open(filename, mode='a', newline='') as csv_file:
                        ...
                        # Write the final engagement data
                        writer.writerow(final_engagement_data)
        ...
        # send_data_to_backend(csv_data)  # Send the data to the backend
